...
mysqli_query($con,"UPDATE reservations SET r_cancel_request='' WHERE r_client_id='$clientid' and r_trip_id='$flightid'");


mysqli_query($con,"INSERT INTO exchanging_message(m_id, m_date, m_time, m_company_id, m_employee_id, m_client_id, m_details)
 VALUES (Null,'$m_date','$m_time','$company_id','$e_id','$clientid','cancel accepted')");
 ...
 $client_name=mysqli_query($con,"select * from reservation where r_flight_id='$flightid' and r_client_id='$clientid'");
    ...
    $details='your employee accept to cancel reservation for passenger '.$passenger.' on trip '.$flightid;

mysqli_query($con,"INSERT INTO event_history(event_id, event_date, event_time, event_action, event_details, event_actor_id)
 VALUES (Null,'$m_date','$m_time','igrone_cancel_reservation','$details','$e_id')");
//mysqli_close($con);
...
$m_details="accept cancel request";
